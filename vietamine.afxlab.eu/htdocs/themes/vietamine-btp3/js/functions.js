jQuery(document).ready(function($){
	...
	$('#header-login-form').submit(function(){
		...
		if($('#header-form-login').val() != '' && $('#header-form-pass').val() != '')
		{
			...
			$.ajax({
				...
				success: function(data)
				{
					...
					$('#header-login-form .ajax-loader').css('display', 'none');
				},
		...
		{
			if($('#header-form-login').val() == '') $('#header-form-login').parent().addClass('has-error');
			if($('#header-form-pass').val() == '') $('#header-form-pass').parent().addClass('has-error');
		}
	});
	...
	$('#contact-form').submit(function(){
		if($('#contact-fullname').val() != "" && $('#contact-mail').val() != "" && $('#contact-message').val() != "")
		{
	...
	$('#form-signin').submit(function(){
		...
		$('#message').hide();
		$('button').hide();
		$('#form-signin .ajax-loader').css('display', 'inline-block');
		var rememberMe;
