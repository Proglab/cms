...
$cs->registerScriptFile('/themes/vietamine-btp3/js/afx/catalog/edit.js',CClientScript::POS_END);
...
<div class="panel panel-default bottom-20" id="all-forms-panel">
  <div class="panel-heading">Fiche produit</div>
    <div class="panel-body">
          ...
          <div class="accordion-body">
            <form onsubmit="return false;">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input class="form-control" type="text" id="form-title" name="title" value="<?= $product->title; ?>">
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9 ">
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" id="form-limited_stock" name="limited_stock" value="1" <?= $product->stock > 0 ? 'checked="checked"' : ''; ?>> Places limitées
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input class="form-control" type="text" id="form-stock" name="stock" placeholder="Places disponibles" value="<?= $product->stock; ?>">
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9 ">
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" id="form-active" name="active" <?= $product->active == 1 ? 'checked="checked"' : ''; ?> value="1"> Actif
                    </label>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group clearfix">
                <div class="col-sm-offset-3 col-sm-9">
                  <button type="submit" class="button">Sauver <i class="fa fa-save"></i></button>
                </div><!-- // .field -->
              </div>
      ...
      <div class="panel accordion-item" data-cat="descriptions">
        <div class="accordion-heading">
          <h5 class="accordion-title">
            <a class="collapsed" data-toggle="collapse" data-parent="#accordion">
          ...
          <div class="accordion-body">
            <form onsubmit="return false;">
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" id="form-description_short" name="description_short"><?= $product->description_short; ?></textarea>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control rte" style="height: 300px;" id="form-description" name="description"><?= $product->description; ?></textarea>
                </div>
              </div>
      ...
      <div class="panel accordion-item" data-cat="images">
        <div class="accordion-heading">
          <h5 class="accordion-title">
            <a class="collapsed" data-toggle="collapse" data-parent="#accordion">
        ...
        <div class="accordion-collapse collapse">
          <div class="accordion-body">
            <form onsubmit="return false;" enctype="multipart/form-data">
              ...
              <div class="form-group clearfix">
                <div class="col-sm-offset-3 col-sm-9">
                  <button type="submit" class="button">Sauver <i class="fa fa-save"></i></button><span class="ajax-loader"></span>
                </div><!-- // .field -->
              </div>
      ...
      <div class="panel accordion-item" data-cat="dates">
        <div class="accordion-heading">
          <h5 class="accordion-title">
            <a class="collapsed" data-toggle="collapse" data-parent="#accordion">
          ...
          <div class="accordion-body">
            <form onsubmit="return false;">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input class="form-control datepicker" type="text" id="form-diffusion_start_date" name="diffusion_start_date" placeholder="Début de diffusion sur le site" value="<?= $product->diffusion_start_date; ?>">
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input class="form-control datepicker" type="text" id="form-diffusion_end_date" name="diffusion_end_date" placeholder="Fin de diffusion sur le site" value="<?= $product->diffusion_end_date; ?>">
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-sm-offset-3 col-sm-9 ">
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" id="form-precise_timtable" name="precise_timtable" value="1"> Horaire précis
      ...
      <div class="panel accordion-item" data-cat="geolocalisation">
        <div class="accordion-heading">
          <h5 class="accordion-title">
            <a class="collapsed" data-toggle="collapse" data-parent="#accordion">
      ...
      <div class="panel accordion-item" data-cat="formules">
        <div class="accordion-heading">
          <h5 class="accordion-title">
            <a class="collapsed" data-toggle="collapse" data-parent="#accordion" >
      ...
      <div class="panel accordion-item" data-cat="seo">
        <div class="accordion-heading">
          <h5 class="accordion-title">
            <a class="collapsed" data-toggle="collapse" data-parent="#accordion">
          ...
          <div class="accordion-body">
            <form onsubmit="return false;">
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input class="form-control" type="text" id="form-seo_title" name="seo_title" value="<?= $product->seo_title; ?>">
                </div>
              </div>
              ...
              <div class="form-group clearfix">
                ...
                <div class="col-sm-9">
                  <textarea class="form-control" type="text" id="form-seo_description" name="seo_description"><?= $product->seo_description; ?></textarea>
                </div>
              </div>
              <!--
              <hr>
              ...
              <div class="form-group clearfix">
                <div class="col-sm-offset-3 col-sm-9">
                  <button type="submit" class="button">Sauver <i class="fa fa-plus"></i></button>
                </div>
              </div>
